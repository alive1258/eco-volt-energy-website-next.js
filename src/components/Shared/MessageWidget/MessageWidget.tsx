        ...
        {!isLoggedIn ? (
          <div className="flex flex-col items-center gap-2.5 px-5 py-10 text-center">
            ...
            <button
              type="button"
              onClick={goToLogin}
              className="mt-2 rounded-lg bg-gold-500 px-4 py-2 text-xs font-semibold text-brand-900 transition hover:bg-gold-400"
            >
              Log In / Sign Up
            </button>
          </div>
          ...
          <>
            ...
            >
              ...
              <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gold-500 text-brand-900 transition hover:bg-gold-400 disabled:cursor-not-allowed disabled:opacity-40"
              >
                <Send size={15} />
              </button>
            </form>
